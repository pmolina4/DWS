...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //SI EXISTEN TODAS LAS VARIABLES SIGNIFICA QUE SE CREÓ CON EXITO 
    if(isset($nombre)&&isset($videojuego)&&isset($edad)&&isset($genero)){

        echo "Introducido correctamente. <br> ";
    }
