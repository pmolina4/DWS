...
$pdf->Cell(150, 10, utf8_decode(strtoupper("Cenec Moda")), 0, 0, 'L');
...
$pdf->Cell(150, 9, utf8_decode("C/CenecMalaga, Málaga"), 0, 0, 'L');
...
$pdf->Cell(150, 9, utf8_decode("Email: cenecmalaga@cenecmalaga.es"), 0, 0, 'L');
...
$pdf->SetTextColor(97, 97, 97);
$pdf->Cell(134, 7, utf8_decode("Pablo Molina"), 0, 0, 'L');
$pdf->SetFont('Arial', 'B', 10);
$pdf->SetTextColor(97, 97, 97);
...
$pdf->SetTextColor(97, 97, 97);
session_start();
$pdf->Cell(60, 7, utf8_decode($_SESSION["usuario"]), 0, 0, 'L');
$pdf->SetTextColor(39, 39, 51);
...
$pdf->SetTextColor(97, 97, 97);
$pdf->Cell(109, 7, utf8_decode("Centro Cenec, Málaga, Centro"), 0, 0);
...
$pdf->Cell(34, 7, utf8_decode("+ ".$total." EUR"), 'T', 0, 'C');
